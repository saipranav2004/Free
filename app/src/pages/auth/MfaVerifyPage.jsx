  ...
  const mutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      if (result?.used_backup_code) {
        const left = result.backup_codes_remaining ?? 0
        toast.warning(
          left > 0
                ...
                {method === 'totp' ? (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled={mutation.isPending}
                      className={[
                        'h-[3.25rem] w-full rounded-xl border bg-white px-4 text-center font-mono text-lg tracking-[0.12em] text-slate-900 shadow-[0_1px_2px_rgb(15_23_42/0.04)]',
