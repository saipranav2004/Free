...
const fieldClass = (hasError) =>
  [
    // auth-field: see index.css. Keeps browser autofill on this always-white
    // card from being repainted with the app theme's dark well.
    'auth-field h-[3.125rem] w-full rounded-xl border bg-white px-4 text-[0.9375rem] text-slate-900 shadow-[0_1px_2px_rgb(15_23_42/0.04)]',
